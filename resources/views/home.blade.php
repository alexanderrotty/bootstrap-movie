...
<div class="container mt-5">
  ...
  <div class="row">
    <div class="col-sm-4">
      ...
      <p><svg width="24" height="24" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="475.099px" height="475.099px" viewBox="0 0 475.099 475.099" style="enable-background:new 0 0 475.099 475.099;" xml:space="preserve">
        <g>
            <path d="M442.829,265.532c9.328-14.089,13.986-29.598,13.986-46.538c0-19.607-7.225-36.637-21.687-51.117
                ...
                C420.284,225.943,418.237,233.653,414.145,242.419z"></path>
        </svg>{{$bannerItem->vote_average}}</p>
    ...
    @endforeach
    @foreach ($loopMovies as $bannerItem)
    ...
    <div class="col-sm-8">
      <h2>{{$bannerItem->title}}</h2>
      <h5>{{$bannerItem->release_date}}</h5>
      <img src="{{$imageBaseURL}}//original{{$bannerItem->backdrop_path}}" class="fakeimg2 absolute w-full h-full object-cover" alt="">
      <p>{{$bannerItem->id}}</p>
      <p><svg width="24" height="24" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="475.099px" height="475.099px" viewBox="0 0 475.099 475.099" style="enable-background:new 0 0 475.099 475.099;" xml:space="preserve">
        <g>
            <path d="M442.829,265.532c9.328-14.089,13.986-29.598,13.986-46.538c0-19.607-7.225-36.637-21.687-51.117
